...
class BunghiPageAdmin extends StatefulWidget {
  int id;


  BunghiPageAdmin(this.id);
...
class _Bunghi_containerState extends State<BunghiPageAdmin> {
  ...
  void initState() {
    ...
    this.dataBaseHelper.initializeDB().whenComplete(() async {
      dataBaseHelper.selectEventCalendar(widget.id).then((value) => {
        setState(() {
          eventsList = value;
