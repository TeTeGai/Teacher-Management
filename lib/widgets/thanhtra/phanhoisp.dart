...
class PhanhoiAdmin extends StatefulWidget {
  ...
  PhanhoiAdmin(this.id,this.name,this.date, this.title, this.namett, this.desc, this.clas, this.room,this.idUser);
...
class _PhanhoiState extends State<PhanhoiAdmin> {
